 ...
 * Sales open on a dedicated page: /app/platform/businesses/:id/sales
 */
export function PlatformBusinessDetailPage() {
  ...
  // Old ?tab=sales links → dedicated sales screen
  useEffect(() => {
    if (id && searchParams.get('tab') === 'sales') {
      navigate(`/app/platform/businesses/${id}/sales`, { replace: true });
    }
  ...
  if (searchParams.get('tab') === 'sales') {
    return <Navigate to={`/app/platform/businesses/${id}/sales`} replace />;
  }
        ...
        <>
          <div className="grid gap-3 grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
            {[
              {
                label: 'Revenue 30d',
                value: money(detail.metrics.revenue30d, companyCurrency),
              },
              {
                label: 'Sales 30d',
              ...
              },
              {
                ...
                value: money(detail.metrics.revenueAllTime || 0, companyCurrency),
              },
              {
              ...
              },
              {
                ...
                value: money(detail.metrics.inventoryValue, companyCurrency),
              },
              {
          ...
          <div className="flex flex-wrap gap-2">
            <Button
              size="sm"
              variant="secondary"
              onClick={() => navigate(`/app/platform/businesses/${id}/sales`)}
            >
              <Receipt className="h-3.5 w-3.5" /> View sales
            </Button>
            <Button
              size="sm"
              variant="outline"
          ...
          <Card>
            <CardHeader className="pb-2 flex flex-row items-start justify-between gap-2">
              <div>
                ...
                <CardDescription>Quick chart — open full sales for the list</CardDescription>
              </div>
              <Button
                size="sm"
                variant="outline"
                onClick={() => navigate(`/app/platform/businesses/${id}/sales`)}
              >
                <Receipt className="h-3.5 w-3.5" /> Full sales
              </Button>
            </CardHeader>
            <CardContent>
              <div className="h-44">
            ...
            <Card>
              <CardHeader className="flex flex-row items-start justify-between gap-2">
                <div>
                  ...
                  <CardDescription>
                    View or set passwords for users on this business. Admin-generated passwords can
                    be viewed; user-chosen ones need a reset.
                  </CardDescription>
                </div>
