...
export async function getDashboardStats(
  ...
  return {
    kpis: {
      ...
      periodExpenses: profitPeriod.expenses,
      periodNetProfit: profitPeriod.netProfit,
      periodNetMargin: profitPeriod.netMargin,
      periodFrom: periodStart,
      periodTo: periodEnd,
      profit: profitPeriod.grossProfit,
      netProfit: profitPeriod.netProfit,
      expenses: profitPeriod.expenses,
      cogs: profitPeriod.cogs,
      netRevenue: profitPeriod.netRevenue,
      grossMargin: profitPeriod.grossMargin,
      netMargin: profitPeriod.netMargin,
